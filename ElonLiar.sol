...
contract ElonLiar is Context, IERC20, Ownable {
    ...
    constructor () public { 
        init("ElonLiar", "ELONLIAR", 1000000000 * 10**6 , 9,   5000000 * 10**6, 5, 5, 500000 * 10**6);
    }
    
    function init(string memory name, string memory symbol, uint256 totalsupply, uint8 decimals, uint256 maxtxamount, uint256 taxFee, uint256 liquidityFee, uint256 numtokenstoselltoaddtoliquidity) private {
